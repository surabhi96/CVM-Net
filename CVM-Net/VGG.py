...
class VGG16:
    ...
    def conv_layer(self, x, kernel_dim, input_dim, output_dim, trainable, activated,
        ...
        with tf.variable_scope(name, reuse=tf.AUTO_REUSE):
            # initialize the weights of the layer (mention size) and do xavier initialization
    ...
    def VGG16_conv(self, x, keep_prob, trainable, name):
        ...
        with tf.variable_scope(name, reuse=tf.AUTO_REUSE):
            # layer 1: conv3-64
            ###### trainable false but do xavier initialization?? train from start?
            ...
            #only the conv_4 and conv_5 layers are trainable, freeze others 
            # layer 11: conv3-512
            ...
            # layer 15: conv3-512
            # x, kernel_dim, input_dim, output_dim, trainable
            # input and output depth dimension is 512!
